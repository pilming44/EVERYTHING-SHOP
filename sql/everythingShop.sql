...
(
    ...
    USER_ROLE_CD VARCHAR(10) DEFAULT '01'              NOT NULL,
...
COMMENT ON COLUMN USER_M.USER_NM IS '이름';
...
ALTER TABLE USER_M
    ALTER COLUMN USER_NUM BIGINT AUTO_INCREMENT NOT NULL;

ALTER TABLE PRODUCT_M
    ALTER COLUMN PRODUCT_NUM BIGINT AUTO_INCREMENT NOT NULL;

ALTER TABLE ORDER_M
    ALTER COLUMN ORDER_NUM BIGINT AUTO_INCREMENT NOT NULL;

ALTER TABLE ORDER_PRODUCT
    ALTER COLUMN ORDER_PRODUCT_NUM BIGINT AUTO_INCREMENT NOT NULL;